...
imagedir='../data/'+savefold+'/'+str(i+1)+'_img.mat'
labeldir='../data/'+savefold+'/'+str(i+1)+'_seg.mat'
print 'imagedir: ',imagedir
print 'labeldir: ',labeldir
image=sio.loadmat(imagedir)
oriimage=image['intensity']
label=sio.loadmat(labeldir)
...
np.save('../bigfile/'+savefold+'/img'+str(i+1)+'.npy',images)
np.save('../bigfile/'+savefold+'/seg'+str(i+1)+'.npy',labels)
