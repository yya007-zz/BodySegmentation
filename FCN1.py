...
wd = 5e-4
data_dict = np.load("../bigfile/vgg16.npy", encoding='latin1').item()

def FCN(bgr,keep_prob=0.5,train=False, number_of_classes=20, random_init_fc8=False,
          debug=False):
    """
    ...
    score_pool1 = _score_layer(pool1, "score_pool1",
                                         num_classes=num_classes)
    fuse_pool1 = tf.add(upscore2, score_pool3)
