...
def seg(weights_path=None):
    ...
    #subsample
    model.add(Deconvolution2D(ClassNumber, 2, 2, output_shape=(1,32,32,ClassNumber), subsample=(2, 2),border_mode='valid'))
    model.add(Deconvolution2D(ClassNumber, 2, 2, output_shape=(1,64,64,ClassNumber), subsample=(2, 2),border_mode='valid'))
    model.add(Deconvolution2D(ClassNumber, 2, 2, output_shape=(1,128,128,ClassNumber), subsample=(2, 2),border_mode='valid'))
    model.add(Deconvolution2D(ClassNumber, 2, 2, output_shape=(1,256,256,ClassNumber), subsample=(2, 2),border_mode='valid'))
    model.add(Deconvolution2D(ClassNumber, 2, 2, output_shape=(1,512,512,ClassNumber), subsample=(2, 2),border_mode='valid'))
    if weights_path:
...
if __name__ == "__main__":
    ...
    model.fit(testimage, testlabel, batch_size=100, nb_epoch=10,shuffle=True)
    out = model.predict(testimage)
    print out.shape
