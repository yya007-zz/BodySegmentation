# -*- coding: utf-8 -*-
"""
Created on Thu Dec 22 22:47:31 2016
...
#sys.path.append("/fs4/masi/huoy1/DeepInCyte/onlineResource/tfModels/models/slim")
sys.path.append(home+'/DeepInCyte/yuang/models/slim')
#checkpoints_dir = '/fs4/masi/huoy1/DeepInCyte/test/checkpoints'
checkpoints_dir = home+'/DeepInCyte/test'
...
# Load the mean pixel values and the functionhttps://github.com/warmspringwinds/tensorflow_notes.git
...
number_of_classes = 2
#home='/fs4/masi/huoy1'
log_folder = home+'/DeepInCyte/test/log'
...
shape=downsampled_logits_shape
...
cross_entropies = tf.nn.softmax_cross_entropy_with_logits(logits=flat_logits,labels=flat_logits)
...
with tf.Session() as sess:
    ...
    ##for i in range(10):
        print i
        loss, summary_string,downsampled_logits_shape= sess.run([cross_entropy_sum, merged_summary_op,shape],
                                        feed_dict=feed_dict_to_use)
	print downsampled_logits_shape
